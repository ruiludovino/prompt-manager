...
export function Library({ favoritesOnly = false }: { favoritesOnly?: boolean }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-8 py-8">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        <div className="flex flex-1 min-w-64 items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2.5">
